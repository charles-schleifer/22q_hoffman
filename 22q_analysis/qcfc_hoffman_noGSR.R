...
# unique roi pairs
roipairs <- as.vector(unique(all_bparc_nogsr$rois))
...
#qsub -cwd -V -o /u/project/cbearden/data/22q/qunex_studyfolder/processing/logs/manual/qcfc_nogsr.$(date +%s).o -e /u/project/cbearden/data/22q/qunex_studyfolder/processing/logs/manual/qcfc_nogsr.$(date +%s).e  -l h_data=16G,h_rt=24:00:00 /u/project/cbearden/data/22q/qunex_studyfolder/analysis/scripts/submit_qcfc_noGSR.sh 
